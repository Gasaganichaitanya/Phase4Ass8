...
namespace WebAppAzureAss8.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(Books8919dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Authors != null ? 
                          ...
                          Problem("Entity set 'Books8919dbContext.Authors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Books8919dbContext.Authors'  is null.");
            }
            var author = await _context.Authors.FindAsync(id);
            if (author != null)
            {
